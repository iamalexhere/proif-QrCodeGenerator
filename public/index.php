...
<body>
            ...
            <div class="content">
                <div class="inputsection">
                    <form id="qrForm" method="post" enctype="multipart/form-data">
                                ...
                                <div class="accordion-content" id="color-content">
                                    <div style="padding-top: 5px;">
                                        ...
                                        <div class="color-picker-row" style="display: flex; align-items: center; gap: 15px; margin-top: 10px;">
                                            <input type="color" name="qr_color" id="qr_color" value="#000000" style="width: 60px; height: 40px; border: 2px solid #ddd; border-radius: 5px; cursor: pointer;">
                                            <input type="text" id="qr_color_hex" value="#000000" placeholder="#000000" maxlength="7" class="hex-input" style="width: 100px; padding: 8px; border: 1px solid #ddd; border-radius: 5px; font-family: monospace;">
                                        ...
                                        <small style="color: #666; font-size: 12px; display: block; margin-top: 5px;">Choose a color for your QR code. Avoid very light colors for better scanning.</small>
                                    </div>

                                    <div style="padding-top: 15px;">
                                        <label class="url-input" for="qr_bg_color">QR Code Background Color:</label>
                                        <div class="color-picker-row" style="display: flex; align-items: center; gap: 15px; margin-top: 10px;">
                                            <input type="color" name="qr_bg_color" id="qr_bg_color" value="#FFFFFF" style="width: 60px; height: 40px; border: 2px solid #ddd; border-radius: 5px; cursor: pointer;">
                                            <input type="text" id="qr_bg_color_hex" value="#FFFFFF" placeholder="#FFFFFF" maxlength="7" class="hex-input" style="width: 100px; padding: 8px; border: 1px solid #ddd; border-radius: 5px; font-family: monospace;">
                                            <button type="button" id="reset-bg-color" class="btn" style="background-color: #6c757d; padding: 8px 15px; font-size: 12px;">Reset to White</button>
                                        </div>
                                        <small style="color: #666; font-size: 12px; display: block; margin-top: 5px;">Background should have good contrast with foreground color.</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div class="accordion-content" id="preview-content">
                                    <div style="padding-top: 5px;">
                                        ...
                                        <div id="color-preview" style="margin-top: 10px; padding: 20px; border: 2px solid #ddd; border-radius: 8px; text-align: center; transition: all 0.3s ease;">
                                            <div style="width: 100px; height: 100px; margin: 0 auto; border-radius: 8px; display: flex; align-items: center; justify-content: center; font-size: 48px; transition: all 0.3s ease; background: #FFFFFF; color: #000000;" id="preview-box">▀▄▀▄</div>
                        ...
                        <?php if ($isLoggedIn): ?>
                            <div id="quota-display" style="padding: 15px; background: #f8f9fa; border-radius: 8px; margin: 15px 0;">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                                    <span><strong>Monthly Quota:</strong></span>
                                    <span id="quota-text"><?php echo $quotaInfo['used']; ?> / <?php echo $quotaInfo['limit']; ?> QR Codes</span>
                                </div>
                                <div style="background: #e9ecef; border-radius: 10px; height: 8px; overflow: hidden;">
                                    <div id="quota-bar" style="background: <?php echo $quotaInfo['used'] >= $quotaInfo['limit'] ? '#dc3545' : '#28a745'; ?>; height: 100%; width: <?php echo ($quotaInfo['used'] / $quotaInfo['limit']) * 100; ?>%; transition: width 0.3s ease, background 0.3s ease;"></div>
                                </div>
                                ...
                                <div id="quota-warning" style="display: <?php echo !$quotaInfo['canCreate'] ? 'block' : 'none'; ?>;">
                            ...
                            <div class="form-submit">
                                <button type="submit" id="generate-btn" class="btn" <?php echo !$quotaInfo['canCreate'] ? 'disabled style="opacity:0.6;cursor:not-allowed;"' : ''; ?>>
                        ...
                        <?php else: ?>
                            <div style="padding: 20px; background: #fff3cd; border: 1px solid #ffeaa7; border-radius: 8px; margin: 15px 0; text-align: center;">
                                ...
                                <a href="login.php" class="btn" style="background: #007bff; color: white; text-decoration: none; padding: 10px 20px; border-radius: 5px;">Login with Google</a>
                            </div>
                        <?php endif; ?>
                    </form>
                </div>
                ...
                <div class="outputsection">
                    ...
                    <div id="qr-output-container">
                        <div id="empty-state" style="width: 300px; height: 300px; border: 2px dashed #ccc; border-radius: 12px; display: flex; flex-direction: column; align-items: center; justify-content: center; background: #f9f9f9; color: #666; text-align: center; margin: 0 auto;">
    ...
    <footer>
        <div>Copyright &copy; 2025 <a class="text-body" href="https://aaaro.app/">AAARO</a></div>
    </footer>
