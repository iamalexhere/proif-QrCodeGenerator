    ...
    <div class="main-content">
      ...
      <main class="dashboard">
        ...
        <div class="qr-card">
          ...
          <div class="actions">
            <a href="edit.php?code=abc123&return=dashboardActive.php" class="btn-edit">Edit</a>
        ...
        <div class="qr-card">
          ...
          <div class="actions">
            <a href="edit.php?code=xyz999&return=dashboardActive.php" class="btn-edit">Edit</a>
            <button class="btn-download">Download</button>
          </div>
          <div class="qr-image-wrapper">
            <img src="images/sample_qr.png" alt="QR Code" class="qr-image">
